...
-   [ ] [Create a Next.js App](https://nextjs.org/learn/basics/create-nextjs-app)
    -   [ ] [Setup](https://nextjs.org/learn/basics/create-nextjs-app/setup)
    -   [ ] [Welcome to Next.js](https://nextjs.org/learn/basics/create-nextjs-app/welcome-to-nextjs)
    -   [ ] [Editing the Page](https://nextjs.org/learn/basics/create-nextjs-app/editing-the-page)
-   [ ] [Navigate Between Pages](https://nextjs.org/learn/basics/navigate-between-pages)
    -   [ ] [Setup](https://nextjs.org/learn/basics/navigate-between-pages/setup)
    -   [ ] [Pages in Next.js](https://nextjs.org/learn/basics/navigate-between-pages/pages-in-nextjs)
    -   [ ] [Link Component](https://nextjs.org/learn/basics/navigate-between-pages/link-component)
...
-   [ ] [Assets, Metadata, and CSS](https://nextjs.org/learn/basics/assets-metadata-css)
    -   [ ] [Setup](https://nextjs.org/learn/basics/assets-metadata-css/setup)
    ...
    -   [ ] [Third-Party JavaScript](https://nextjs.org/learn/basics/assets-metadata-css/third-party-javascript)
    -   [ ] [CSS Styling](https://nextjs.org/learn/basics/assets-metadata-css/css-styling)
    -   [ ] [Layout Component](https://nextjs.org/learn/basics/assets-metadata-css/layout-component)
    -   [ ] [Global Styles](https://nextjs.org/learn/basics/assets-metadata-css/global-styles)
    -   [ ] [Polishing Layout](https://nextjs.org/learn/basics/assets-metadata-css/polishing-layout)
...
-   [ ] [Pre-rendering and Data Fetching](https://nextjs.org/learn/basics/data-fetching)
    -   [ ] [Setup](https://nextjs.org/learn/basics/data-fetching/setup)
    ...
    -   [ ] [Blog Data](https://nextjs.org/learn/basics/data-fetching/blog-data)
    -   [ ] [Implement getStaticProps](https://nextjs.org/learn/basics/data-fetching/implement-getstaticprops)
...
-   [ ] [Dynamic Routes](https://nextjs.org/learn/basics/dynamic-routes)
    -   [ ] [Setup](https://nextjs.org/learn/basics/dynamic-routes/setup)
    ...
    -   [ ] [Implement getStaticProps](https://nextjs.org/learn/basics/dynamic-routes/implement-getstaticprops)
    -   [ ] [Render Markdown](https://nextjs.org/learn/basics/dynamic-routes/render-markdown)
    -   [ ] [Polishing the Post Page](https://nextjs.org/learn/basics/dynamic-routes/polishing-post-page)
    -   [ ] [Polishing the Index Page](https://nextjs.org/learn/basics/dynamic-routes/polishing-index-page)
...
-   [ ] [API Routes](https://nextjs.org/learn/basics/api-routes)
    -   [ ] [Setup](https://nextjs.org/learn/basics/api-routes/setup)
...
-   [ ] [Deploying Your Next.js App](https://nextjs.org/learn/basics/deploying-nextjs-app)
    -   [ ] [Setup](https://nextjs.org/learn/basics/deploying-nextjs-app/setup)
    -   [ ] [Push to GitHub](https://nextjs.org/learn/basics/deploying-nextjs-app/github)
    -   [ ] [Deploy to Vercel](https://nextjs.org/learn/basics/deploying-nextjs-app/deploy)
    -   [ ] [Next.js and Vercel](https://nextjs.org/learn/basics/deploying-nextjs-app/platform-details)
    -   [ ] [Other Hosting Options](https://nextjs.org/learn/basics/deploying-nextjs-app/other-hosting-options)
    -   [ ] [Finally](https://nextjs.org/learn/basics/deploying-nextjs-app/finally)
